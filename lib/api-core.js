    ...
    },
    {
      ...
      detail: protocolOk
        ...
        : responseModelMismatch
          ? profileSignals.fixedTargetMode
            ? `Requested model id ${model} does not match target ${targetModel}.`
      ...
      detailZh: protocolOk
        ...
        : responseModelMismatch
          ? profileSignals.fixedTargetMode
            ? `实际请求 ID ${model} 与目标模型 ${targetModel} 不匹配。`
