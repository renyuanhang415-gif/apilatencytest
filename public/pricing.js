...
const providerSets = {
  gpt55: [
    { name: "Yunwu", url: "https://yunwu.ai/register", group: "public-lowest", input: 1.5, output: 9 },
    { name: "Plato", url: "https://api.bltcy.ai/register", group: "public-lowest", input: 5, output: 30 },
    { name: "QianDuoDuo", url: "https://api2.aigcbest.top/register", group: "public-lowest", input: 262.5, output: 1575 },
  ],
  opus47: [
    { name: "Packy", url: "https://www.packyapi.com/register", group: "public-lowest", input: 1.5, output: 7.5 },
    { name: "Yunwu", url: "https://yunwu.ai/register", group: "public-lowest", input: 2.5, output: 12.5 },
    { name: "Plato", url: "https://api.bltcy.ai/register", group: "public-lowest", input: 4, output: 20 },
    { name: "QianDuoDuo", url: "https://api2.aigcbest.top/register", group: "public-lowest", input: 17.5, output: 87.5 },
  ],
  gpt54: [
